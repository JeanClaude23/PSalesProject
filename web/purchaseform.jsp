<%-- 
    ...
    Created on : Sep 25, 2021, 7:47:22 AM
    Author     : JClaude
--%>
...
<html>
    <head>
        ...
        <script>
            var baseurl = "http://localhost:8080/PSalesProject/api/purch/Display";
            $.getJSON(baseurl, function (list) {
                for (i = 0; i < list.length; i = i + 1) {
                    ...
                    row.insertCell(1).innerHTML = list[i].total_cost;
                    row.insertCell(2).innerHTML = '<td><button class="btn btn-primary edit-row" data-id="#" style="margin-right: 2px;" data-toggle="modal" data-target="#modal-edit">Edit</button><button class="btn btn-danger delete-row" data-id="#"><i class="fa fa-trash"></i></button></td>';
                ...
                <section class="content container-fluid">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <a href="purchaselist.jsp" target="purchaselist.jsp" >View</a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" style="color: blue;">Purchase</h4>
                        </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#regPurchase").on('submit', (function (e) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: 'http://localhost:8080/PSalesProject/AddPurchase',

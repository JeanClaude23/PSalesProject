<%-- 
    ...
    Created on : Sep 24, 2021, 2:34:26 PM
    Author     : JClaude
--%>
...
<html>
    <head>
        ...
        <script>
            ...
            $.getJSON(baseurl, function (list) {
                for (i = 0; i < list.length; i = i + 1) {
                    ...
                    row.insertCell(2).innerHTML = '<a class="btn btn-primary edit-row" data-id="#" style="margin-right: 2px;" data-toggle="modal" data-target="#modal-edit" href=http://localhost:8080/PSalesProject/cateList.jsp?id=' + list[i].catid + '&name=' + list[i].name + '>Update</a>';
                    row.insertCell(3).innerHTML = '<a class="btn btn-primary edit-row" data-id="#" style="margin-right: 2px;" data-toggle="modal" data-target="#modal-edit" href=http://localhost:8080/PSalesProject/api/cate/delete?id=' + list[i].catid + '>Delete</a>';
        ...
        <script>
//            var baseurl = "http://192.168.10.173:8080/PSalesProject/api/cate";
//            function loadCategories() {
//                var xmlhttp = new XMLHttpRequest();
//                xmlhttp.open("GET", baseurl + "/listAll", true);
...
<!--                        <button class="btn btn-info logout">Log out</button>-->
                ...
                <section class="content container-fluid">
                    ...
                    <div class="box">
                        ...
                        <div class="box-header">
                            ...
                            <a href="index.html" target="index.html" >View</a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" style="color: blue;">Categories</h4>
                            ...
                            <form class="form-horizontal" id="addCategory">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="categoryId" class="col-sm-2 control-label">CID</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="categoryid" id="id"  placeholder="category id" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="categoryname" id="name"  placeholder="Name" required="">
                                        </div>
                                    </div>
        ...
        <script>
             $("#addCategory").on('submit', (function (e) {
                e.preventDefault();
                $.ajax({
                    url: "http://localhost:8080/PSalesProject/api/cate/category",
                    type: "POST",
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('.edit-row').click(function (e) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: 'http://192.168.10.173:8080/PSalesProject/api/cate/tb',
